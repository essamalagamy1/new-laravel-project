...
class UpdateSiteSetting extends Component
{
    ...
    public $payment_transaction_title;

    public $payment_transaction_value;

    public $payment_transaction_title_2;

    public $payment_transaction_value_2;
    ...
    public function mount(): void
    {
        ...
        $this->maintenance_mode = (bool) ($this->setting->maintenance_mode ?? false);
        ...
        $this->tax_percentage = $this->setting->tax_percentage ?? 0;
        $this->payment_transaction_title = $this->setting->payment_transaction_details['title'] ?? null;
        $this->payment_transaction_value = $this->setting->payment_transaction_details['value'] ?? null;
        $this->payment_transaction_title_2 = $this->setting->payment_transaction_details['title_2'] ?? null;
        $this->payment_transaction_value_2 = $this->setting->payment_transaction_details['value_2'] ?? null;
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_transaction_title' => 'required|string|max:255',
            'payment_transaction_value' => 'required|string|max:255',
            'payment_transaction_title_2' => 'nullable|string|max:255',
            'payment_transaction_value_2' => 'nullable|string|max:255',
        ];
    }
    ...
    public function saveUpdate(): void
    {
        ...
        $data = [
            ...
            'payment_transaction_details' => [
                'title' => $this->payment_transaction_title,
                'value' => $this->payment_transaction_value,
                'title_2' => $this->payment_transaction_title_2,
                'value_2' => $this->payment_transaction_value_2,
            ],
            'phone' => $this->phone,
            'email' => $this->email,
        ...
        $this->redirectIntended(route('site-settings'));
    }
