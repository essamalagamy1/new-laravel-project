...
class UserData extends Component
{
    ...
    {
        $this->all_user = User::get(['id', 'name', 'username'])->toArray();
    ...
    {
        $data['users'] = User::when($this->search_user_id, fn (Builder $query) => $query->where('id', $this->search_user_id))->latest()->paginate(10);
