...
return [
    ...
    */
    ...
    | Smart wire:key
    |---------------------------------------------------------------------------
    | When true, helps prevent wire:key issues on deeply nested components.
    ...
    */
    ...
    | Component Locations
    |---------------------------------------------------------------------------
    | Defines where Livewire looks for single-file and multi-file components.
    |
    */
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:5242880'],       // Example: ['file', 'mimes:png,jpg']  | Default: ['required', 'file', 'max:5242880'] (5 MB)
