...
<x-card title="{{ __('lang.admins') }}" shadow class="mb-3">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
            <x-ui.choices-advanced-search label="{{ __('lang.admins') }}" wire:model.live="search_admin_id" :options="$all_admin" single clearable searchable option-value="id" option-label="name" option-sub-label="email"
