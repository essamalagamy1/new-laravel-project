...
<x-nav sticky full-width>
	<x-slot:brand>
		...
		{{-- Brand --}}
		<a href="{{config('app.url')}}" class="w-10 ms-2 text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
	...
	<x-slot:actions class="!gap-2">
		...
		<div class="dropdown dropdown-end">
			<label tabindex="0" class="btn btn-ghost btn-circle  btn-sm">
				<i class="fas fa-globe-americas text-lg sm:text-xl"></i>
			</label>
...
@include('partials.bunny-uploader')
</body>
</html>