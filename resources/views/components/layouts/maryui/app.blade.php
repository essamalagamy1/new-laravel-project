	...
	<x-slot:actions class="!gap-2">
			...
			<ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 max-w-6xl p-2 shadow">
				<li>
					...
					'text-gray-700 dark:text-gray-300'}}"
					   href="{{route('web-language','en')}}" wire:navigate>
				...
				<li>
					...
					'text-gray-700 dark:text-gray-300'}}"
					   href="{{route('web-language','ar')}}" wire:navigate>
		...
		<div class="dropdown dropdown-end">
			...
			<ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-xl shadow-lg mt-4 p-3 w-auto min-w-[10rem] z-[999]">
				<li>
					<a href="{{ route('profile') }}" wire:navigate class="flex items-center gap-2 whitespace-nowrap">
						<x-fas-user-cog class="h-4 w-4"/>
						<span class="font-bold">{{ __('lang.profile') }}</span>
					</a>
				</li>
				<li>
					<a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="cursor: pointer" wire:navigate class="flex items-center gap-2 whitespace-nowrap">
...
<x-main with-nav full-width class="flex flex-col flex-grow">
	...
	<x-slot:sidebar drawer="main-drawer" collapsible class="bg-base-100">
		<x-dashboard.admin.main-menu></x-dashboard.admin.main-menu>
	</x-slot:sidebar>
